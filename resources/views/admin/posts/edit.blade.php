    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10  col-md-offset-1">
                <h1>Editar post</h1>
                <hr>
                <form id="new-post-form" enctype="multipart/form-data" action="{{ route('admin.posts.update', ['post'=> $post->id]) }}" method="post">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group floating-label-form-group controls">
                        ...
                        <input type="text"
                               ...
                               required
                               name="subheader"
                               value="{{ old('subheader', $post->subheader) }}">
                        @error('subheader')
                        <span class="invalid-feedback" style="color: darkred" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group ">
                        <label>
                            Publicado
                            <input type="radio" name="published" value="1" @if(old('published', $post->published)) checked @endif>
                        </label> <br>
                        <label>
                            Oculto
                            <input type="radio" name="published" value="0" @if(!old('published', $post->published)) checked @endif>
                        </label>
